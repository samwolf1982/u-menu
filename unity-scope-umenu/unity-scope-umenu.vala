...
namespace Umenu
{
    ...
    const string GROUP_NAME ="com.biryukwolf.umenu.Unity.Scope.Clipboard";
    const string UNIQUE_NAME = "/com/biryukwolf/umenu/unity/scope/clipboard";
    ...
    private static Unity.CategorySet populate_categories()
    {
        ...
        Icon catIcon = new ThemedIcon("umenu-panel");
    ...
    {
       Umenu.search.begin(search, () => { callback(search); });
    }
