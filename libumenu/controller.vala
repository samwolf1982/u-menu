...
namespace Umenu
{
    ...
    public class Controller : GLib.Object
    {
        ...
        private SimpleClipboardStorage storage;
        ...
        public Controller()
        {
            string umenu_dir = Utility.get_user_data_dir();
            ...
            settings_clipboard = new Settings("com.biryukwolf.umenu.clipboard");
            settings_plugins = new Settings("com.biryukwolf.umenu.plugins");

            peas_engine = Peas.Engine.get_default();
            peas_engine.add_search_path(Utility.get_plugins_lib_dir(), Utility.get_plugins_data_dir());
            string user_plugins_dir = Path.build_filename(umenu_dir, "plugins");
            peas_engine.add_search_path(user_plugins_dir, user_plugins_dir);
            peas_engine.enable_loader("python");

            storage = new SimpleClipboardStorage();
